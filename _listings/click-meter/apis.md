...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/accounts/master/_listings/click-meter/apis.md
...
- name: Click Meter - Retrieve current account data
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/accounts/master/_listings/click-meter/account-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/accounts/master/_listings/click-meter/account-get-openapi.md
- name: Click Meter - Retrieve current account data
  x-api-slug: account-get
  description: Retrieve current account data.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/clickmeter-logo.png
